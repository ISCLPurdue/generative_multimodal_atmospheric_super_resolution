...
1. An ERA5 root containing the fields referenced by
   `reproduction/config/atmospheric_prior_13var.yaml`, plus
   `normalize_mean.npz`, `normalize_std.npz`, `lat.npy`, and `lon.npy`.
...
5. The pretrained 13-variable atmospheric diffusion checkpoint.
